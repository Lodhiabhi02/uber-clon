...
const Home = () =>
{
  ...
  // keep your original naming to avoid other diffs in your codebase
  const [destinaction, setDestination] = useState('');
  ...
  {
    if (vehiclePanelOpen) {
      gsap.to(vehiclePanelRef.current, { y: '0%', duration: 0.5, ease: 'power2.out' });
    } else {
      gsap.to(vehiclePanelRef.current, { y: '100%', duration: 0.5, ease: 'power2.in' });
    }
  }, [vehiclePanelOpen]);
  ...
  {
    if (confirmRidePanel) {
      gsap.to(confirmRideRef.current, { y: '0%', duration: 0.5, ease: 'power2.out' });
    } else {
      gsap.to(confirmRideRef.current, { y: '100%', duration: 0.5, ease: 'power2.in' });
    }
  }, [confirmRidePanel]);
  ...
  {
    if (driverRidePanel) {
      gsap.to(driverRideRef.current, { y: '0%', duration: 0.5, ease: 'power2.out' });
    } else {
      gsap.to(driverRideRef.current, { y: '100%', duration: 0.5, ease: 'power2.in' });
    }
  }, [driverRidePanel]);
